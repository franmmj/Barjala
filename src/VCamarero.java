		...
		try {
				...
				Lista.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED));
				{
					TableModel TablaModel = 
						new DefaultTableModel(
								new String[][] { { "Dni", "Nombre", "Telefono" } },
			...
			}
			{
				...
				}
				{
					...
					direccion.setText("Fecha Nacimiento: ");
				}
				{
				...
				{
					contacto = new JLabel();
					contacto.setText("N. Seguridad Social: ");
				}
				{
				...
				}
				{
					...
					.addGroup(jPanel1Layout.createParallelGroup()
					    ...
					    .addGroup(jPanel1Layout.createSequentialGroup()
					        .addGroup(jPanel1Layout.createParallelGroup()
					            .addComponent(contacto, GroupLayout.Alignment.LEADING, 0, 117, Short.MAX_VALUE)
					            .addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
					                .addComponent(nombre, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					                .addGap(0, 67, Short.MAX_VALUE))
					            .addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
					                .addComponent(direccion, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
					                .addGap(0, 12, Short.MAX_VALUE))
					            .addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
					                .addComponent(telefono, GroupLayout.PREFERRED_SIZE, 62, GroupLayout.PREFERRED_SIZE)
					                .addGap(0, 55, Short.MAX_VALUE))
					            .addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
					                .addComponent(correo, GroupLayout.PREFERRED_SIZE, 62, GroupLayout.PREFERRED_SIZE)
					                .addGap(0, 55, Short.MAX_VALUE)))
					        ...
					        .addGroup(jPanel1Layout.createParallelGroup()
					            .addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
					                ...
					                .addGap(141))
					            .addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
					                .addComponent(boxContacto, 0, 185, Short.MAX_VALUE)
					                .addGap(18))
					...
					.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
					.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
					    .addComponent(boxContacto, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE)
